...
export default function ImgStack({ images }) {
    ...
    return (
        <div className="relative flex items-center justify-center w-full h-96 my-12" style={{ display: 'flex', position: 'relative', width: '100%', height: '350px', justifyContent: 'center', alignItems: 'center' }}>
